...
It is generated from these files:
	argcv/proto/longrunning/operations.proto
...
import argcv_status "github.com/argcv/go-argcvapis/status/status"
...
type Operation_Error struct {
	Error *argcv_status.Status `protobuf:"bytes,4,opt,name=error,oneof"`
}
...
func (m *Operation) GetError() *argcv_status.Status {
...
func init() { proto.RegisterFile("argcv/proto/longrunning/operations.proto", fileDescriptor0) }
